...
# load: trait data
trait <- readr::read_csv("C:\\Users\\camil\\OneDrive\\Documents\\Camila\\Publicaciones\\Chapman_Historical Occupancy\\All_species_traits.csv")
...
#write.csv(PCA_BARB, file = "PCA_BARB.csv", row.names = FALSE)
#write.csv(PCA_SAGU, file = "PCA_SAGU.csv", row.names = FALSE)
#write.csv(PCA_TOCHE, file = "PCA_TOCHE.csv", row.names = FALSE)
#write.csv(PCA_HON, file = "PCA_HON.csv", row.names = FALSE)
#write.csv(PCA_FLOR, file = "PCA_FLOR.csv", row.names = FALSE)
#write.csv(PCA_FUSA, file = "PCA_FUSA.csv", row.names = FALSE)

#write.csv(scoresPCATotal_BARB, file = "PCA_Total_BARB.csv")
#write.csv(scoresPCATotal_TOCHE, file = "PCA_Total_TOCHE.csv")
#write.csv(scoresPCATotal_SAGU, file = "PCA_Total_SAGU.csv")
#write.csv(scoresPCATotal_HON, file = "PCA_Total_HON.csv")
#write.csv(scoresPCATotal_FLOR, file = "PCA_Total_FLOR.csv")
#write.csv(scoresPCATotal_FUSA, file = "PCA_Total_FUSA.csv")

#write.csv(loadingsPCATotal_BARB, file = "Loadings_Total_BARB.csv", row.names = FALSE)
#write.csv(loadingsPCATotal_SAGU, file = "Loadings_Total_SAGU.csv", row.names = FALSE)
#write.csv(loadingsPCATotal_TOCHE, file = "Loadings_Total_TOCHE.csv", row.names = FALSE)
#write.csv(loadingsPCATotal_HON, file = "Loadings_Total_HON.csv", row.names = FALSE)
#write.csv(loadingsPCATotal_FLOR, file = "Loadings_Total_FLOR.csv", row.names = FALSE)
#write.csv(loadingsPCATotal_FUSA, file = "Loadings_Total_FUSA.csv", row.names = FALSE)
...
pca_plot_BARB_H <- ggplot(dcc_BARB_H, aes(x = Var1, y = Var2)) +
  ...
  labs(x = "PC1 - Size (60%)", y = "PC2 - Dispersal Hability (16%)") +
  xlim(-5,15) +
  ylim(-8,8) +
  # edit plot
...
saveRDS(BARB_H_hyper_mi, "BARB_H_hyper_mi5.rds")

set.seed(3)
BARB_M_hyper_mi <- hypervolume::hypervolume_svm(PCA_BARB_M_A, name = "BARB_M")

saveRDS(BARB_M_hyper_mi, "BARB_M_hyper_mi5.rds")

# load: hyper volumes
#BARB_H_hyper_mi <- readRDS("BARB_H_hyper_mi5.rds")
#BARB_M__hyper_mi <- readRDS("BARB_M_hyper_mi5.rds")
...
saveRDS(TOCHE_H_hyper_mi, "TOCHE_H_hyper_mi5.rds")

set.seed(3)
TOCHE_M_hyper_mi <- hypervolume::hypervolume_svm(PCA_TOCHE_M_A, name = "TOCHE_M")

saveRDS(TOCHE_M_hyper_mi, "TOCHE_M_hyper_mi5.rds")

# load: hyper volumes
#TOCHE_H_hyper_mi <- readRDS("TOCHE_H_hyper_mi5.rds")
#TOCHE_M__hyper_mi <- readRDS("TOCHE_M_hyper_mi5.rds")
...
saveRDS(SAGU_H_hyper_mi, "SAGU_H_hyper_mi5.rds")

set.seed(3)
SAGU_M_hyper_mi <- hypervolume::hypervolume_svm(PCA_SAGU_M_A, name = "SAGU_M")

saveRDS(SAGU_M_hyper_mi, "SAGU_M_hyper_mi5.rds")

# load: hyper volumes
#SAGU_H_hyper_mi <- readRDS("SAGU_H_hyper_mi5.rds")
#SAGU_M__hyper_mi <- readRDS("SAGU_M_hyper_mi5.rds")
...
saveRDS(HON_H_hyper_mi, "HON_H_hyper_mi5.rds")

set.seed(3)
HON_M_hyper_mi <- hypervolume::hypervolume_svm(PCA_HON_M_A, name = "HON_M")

saveRDS(HON_M_hyper_mi, "HON_M_hyper_mi5.rds")

# load: hyper volumes
#HON_H_hyper_mi <- readRDS("HON_H_hyper_mi5.rds")
#HON_M__hyper_mi <- readRDS("HON_M_hyper_mi5.rds")
...
saveRDS(FLOR_H_hyper_mi, "FLOR_H_hyper_mi5.rds")

set.seed(3)
FLOR_M_hyper_mi <- hypervolume::hypervolume_svm(PCA_FLOR_M_A, name = "FLOR_M")

saveRDS(FLOR_M_hyper_mi, "FLOR_M_hyper_mi5.rds")

# load: hyper volumes
#FLOR_H_hyper_mi <- readRDS("FLOR_H_hyper_mi5.rds")
#FLOR_M__hyper_mi <- readRDS("FLOR_M_hyper_mi5.rds")
...
saveRDS(FUSA_H_hyper_mi, "FUSA_H_hyper_mi5.rds")

set.seed(3)
FUSA_M_hyper_mi <- hypervolume::hypervolume_svm(PCA_FUSA_M_A, name = "FUSA_M")

saveRDS(FUSA_M_hyper_mi, "FUSA_M_hyper_mi5.rds")

# load: hyper volumes
#FUSA_H_hyper_mi <- readRDS("FUSA_H_hyper_mi5.rds")
#FUSA_M__hyper_mi <- readRDS("FUSA_M_hyper_mi5.rds")
...
TR <- read.csv("C:\\Users\\camil\\OneDrive\\Documents\\Camila\\Publicaciones\\Chapman_Historical Occupancy\\All_species_traits.csv", h = T)
...
dat <- read.csv("C:\\Users\\camil\\OneDrive\\Documents\\Camila\\Publicaciones\\Chapman_Historical Occupancy\\SiteSpeciesMatrix.csv", h = T)
...
#KS test
ks.test(A$Comp.1, B$Comp.1)#P = 0.030

ks.test(A$Comp.2, B$Comp.2)# P = 0.32

ks.test(A$Comp.3, B$Comp.3)# P = 0.42
...
p = p + theme(legend.position = c(0.75, 0.9))+ geom_text(x = 6, y = 0.2, label = " p = 0.030" , size = 6)+
...
p = p + theme(legend.position = "none")+ geom_text(x = 2, y = 0.6, label = " p = 0.32", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
...
p = p + theme(legend.position = "none") + geom_text(x = 5, y = 1.5, label = " p = 0.42", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
#KS test
ks.test(A$Comp.1, B$Comp.1)#P = 0.38

ks.test(A$Comp.2, B$Comp.2)# P = 0.64

ks.test(A$Comp.3, B$Comp.3)# P = 0.31
...
p = p + theme(legend.position = c(0.75, 0.9))+ geom_text(x = 6, y = 0.2, label = " p = 0.38" , size = 6)+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "Novel additions", "Shared species"))
...
p = p + theme(legend.position = "none")+ geom_text(x = 3, y = 0.6, label = " p = 0.64", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
p = p + theme(legend.position = "none") + geom_text(x = 3.5, y = 1.5, label = " p = 0.31", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
#KS test
ks.test(A$Comp.1, B$Comp.1)#P = 0.41

ks.test(A$Comp.2, B$Comp.2)# P = 0.35

ks.test(A$Comp.3, B$Comp.3)# P = 0.59
...
p = p + theme_bw(20) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.text=element_text(size=20),axis.title=element_text(size=20), axis.title.x = element_text(margin = unit(c(5, 0, 0, 0), "mm")))
p <- p + xlab("PC1 - Body size (62%) ") + ylab("Trait prbability density") + ggtitle(" ")
p = p + theme(legend.position = c(0.75, 0.9))+ geom_text(x = 10, y = 0.2, label = " p = 0.41" , size = 6)+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "Novel additions", "Shared species"))
...
p = p + theme(legend.position = "none")+ geom_text(x = 3, y = 0.6, label = " p = 0.35", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
p = p + theme_bw(20) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.text=element_text(size=20),axis.title=element_text(size=20), axis.title.x = element_text(margin = unit(c(5, 0, 0, 0), "mm")))
p <- p + xlab("PC3 (9%)") + ylab("Trait probability density") + ggtitle(" ")
p = p + theme(legend.position = "none") + geom_text(x = 4, y = 0.9, label = " p = 0.59", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
p = p + theme(legend.position = c(0.75, 0.9))+ geom_text(x = 6, y = 0.2, label = " p = 0.19" , size = 6)+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "Novel additions", "Shared species"))
...
p = p + theme_bw(20) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.text=element_text(size=20),axis.title=element_text(size=20), axis.title.x = element_text(margin = unit(c(5, 0, 0, 0), "mm")))
p <- p + xlab("PC2 - Dispersal ability (15%)") + ylab("Trait probability density") + ggtitle(" ")
p = p + theme(legend.position = "none")+ geom_text(x = 3, y = 0.7, label = " p = 0.02", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
p = p + theme(legend.position = "none") + geom_text(x = 5, y = 1.25, label = " p = 0.01", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
#KS test
ks.test(A$Comp.1, B$Comp.1)#P = 0.47

ks.test(A$Comp.2, B$Comp.2)# P = 0.48
...
p = p + theme_bw(20) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.text=element_text(size=20),axis.title=element_text(size=20), axis.title.x = element_text(margin = unit(c(5, 0, 0, 0), "mm")))
p <- p + xlab("PC1 - Body size (62%) ") + ylab("Trait prbability density") + ggtitle(" ")
p = p + theme(legend.position = c(0.75, 0.9))+ geom_text(x = 6, y = 0.2, label = " p = 0.47" , size = 6)+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "Novel additions", "Shared species"))
...
p = p + theme_bw(20) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.text=element_text(size=20),axis.title=element_text(size=20), axis.title.x = element_text(margin = unit(c(5, 0, 0, 0), "mm")))
p <- p + xlab("PC2 - Dispersal ability (16%)") + ylab("Trait probability density") + ggtitle(" ")
p = p + theme(legend.position = "none")+ geom_text(x = 2.5, y = 0.6, label = " p = 0.48", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
p = p + theme_bw(20) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.text=element_text(size=20),axis.title=element_text(size=20), axis.title.x = element_text(margin = unit(c(5, 0, 0, 0), "mm")))
p <- p + xlab("PC3 (9%)") + ylab("Trait probability density") + ggtitle(" ")
p = p + theme(legend.position = "none") + geom_text(x = 6, y = 1.5, label = " p = 0.15", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
#KS test
ks.test(A$Comp.1, B$Comp.1)#P = 0.18

ks.test(A$Comp.2, B$Comp.2)# P = 0.90

ks.test(A$Comp.3, B$Comp.3)# P = 0.35
...
p = p + theme_bw(20) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.text=element_text(size=20),axis.title=element_text(size=20), axis.title.x = element_text(margin = unit(c(5, 0, 0, 0), "mm")))
p <- p + xlab("PC1 - Body size (60%) ") + ylab("Trait prbability density") + ggtitle(" ")
p = p + theme(legend.position = c(0.75, 0.9))+ geom_text(x = 9, y = 0.3, label = " p = 0.18" , size = 6)+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "Novel additions", "Shared species"))
...
p = p + theme(legend.position = "none")+ geom_text(x = 3.5, y = 0.7, label = " p = 0.90", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
p = p + theme_bw(20) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),axis.text=element_text(size=20),axis.title=element_text(size=20), axis.title.x = element_text(margin = unit(c(5, 0, 0, 0), "mm")))
p <- p + xlab("PC3 (9%)") + ylab("Trait probability density") + ggtitle(" ")
p = p + theme(legend.position = "none") + geom_text(x = 6, y = 1.5, label = " p = 0.35", size = 6 )+
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), 
                    name=NULL,breaks=c("A", "B", "C"),labels=c("Extirpated species", "New additions", "Shared species"))
...
head(di_df)
#write.csv(di_df, file = "Distinctiveness_BARB.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #-0.7994
obsDifBC <- meanB - meanC #0.7121
...
N_obs <- 241; # Total number of observations
...
ggplot() +
  ...
  geom_vline(xintercept = obsDif, linewidth = 1, 
...
p <- ggplot(Di_Sum, aes(x=POP_BARB, y=Di, fill = POP_BARB, na.rm = T)) + 
  ...
  geom_text(x = 1.5, y = 11.5, label = "p = 0.001")+
  geom_text(x = 2.5, y = 11.5, label = "p = 0.001")+
...
head(ui_df)
#write.csv(ui_df, file = "Uniqueness_BARB.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #-0.164
obsDifBC <- meanB - meanC #0.219
...
p <- ggplot(Ui_Sum, aes(x=POP_BARB, y=Ui, fill = POP_BARB)) + 
  ...
  ylim(0,3)+
  #Text for significant differences and p values between group. Replace values with comparison results.
  geom_text(x = 1.5, y = 3, label = "p = 0.98")+
  geom_text(x = 2.5, y = 3, label = "p = 0.001")+
...
head(di_df)
#write.csv(di_df, file = "Distinctiveness_TOCHE.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #-0.279
obsDifBC <- meanB - meanC #0.393
...
N_obs <- 240; # Total number of observations
...
p <- ggplot(Di_Sum, aes(x=POP_TOCHE, y=Di, fill = POP_TOCHE)) + 
  ...
  ylim(0,12)+
  #Text for significant differences and p values between group. Replace values with comparison results.
  geom_text(x = 1.5, y = 11, label = "p = 0.16")+
  geom_text(x = 2.5, y = 11, label = "p = 0.013")+
...
p <- ggplot(di_df, aes(x=as.factor(Period), y=Di)) + 
  ...
  geom_jitter(data = Y1, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "red",position=position_jitter(0.2)) + 
  geom_jitter(data = Y2, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "cornflowerblue",position=position_jitter(0.2)) + 
  geom_segment(aes(x = 0.5, y = 2.83, xend = 1.5, yend = 2.83))+
  geom_segment(aes(x = 1.5, y = 3.09, xend = 2.5, yend = 3.09))+
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.background = element_rect(fill='white', colour = "black"),
        axis.text = element_text(colour = "black"),
...
head(ui_df)
#write.csv(ui_df, file = "Uniqueness_TOCHE.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #0.086
obsDifBC <- meanB - meanC #0.066
...
p <- ggplot(Ui_Sum, aes(x=POP_TOCHE, y=Ui, fill = POP_TOCHE)) + 
  ...
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), labels = c("Extirpated","New additions","Shared species"))+
  ylim(0,4)+
  geom_text(x = 1.5, y = 3.8, label = "p = 0.236")+
  geom_text(x = 2.5, y = 3.8, label = "p = 0.213")+
...
head(di_df)
#write.csv(di_df, file = "Uniqueness_FUSA.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #0.143
obsDifBC <- meanB - meanC #0.196
...
N_obs <- 217; # Total number of observations
...
p <- ggplot(Di_Sum, aes(x=POP_FUSA, y=Di, fill = POP_FUSA)) + 
  ...
  #ylim(0,12)+
  #Text for significant differences and p values between group. Replace values with comparison results.
  geom_text(x = 1.5, y = 11, label = "p = 0.261")+
  geom_text(x = 2.5, y = 11, label = "p = 0.161")+
...
p <- ggplot(di_df, aes(x=as.factor(Period), y=Di)) + 
  ...
  geom_jitter(data = Y1, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "red",position=position_jitter(0.2)) + 
  geom_jitter(data = Y2, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "cornflowerblue",position=position_jitter(0.2)) + 
  geom_segment(aes(x = 0.5, y = 2.31, xend = 1.5, yend = 2.31))+
  geom_segment(aes(x = 1.5, y = 2.16, xend = 2.5, yend = 2.16))+
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.background = element_rect(fill='white', colour = "black"),
        axis.text = element_text(colour = "black"),
...
head(ui_df)
#write.csv(ui_df, file = "Uniqueness_FUSA.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #0.099
obsDifBC <- meanB - meanC #0.143
...
p <- ggplot(Ui_Sum, aes(x=POP_FUSA, y=Ui, fill = POP_FUSA)) + 
  ...
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), labels = c("Extirpated","New additions","Shared species"))+
  ylim(0,5)+
  geom_text(x = 1.5, y = 4.3, label = "p = 0.21")+
  geom_text(x = 2.5, y = 4.3, label = "p = 0.13")+
...
head(di_df)
#write.csv(di_df, file = "Distinctiveness_HON.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #-0.48
obsDifBC <- meanB - meanC #0.69
...
N_obs <- 232; # Total number of observations
...
p <- ggplot(Di_Sum, aes(x=POP_HON, y=Di, fill = POP_HON)) + 
  ...
  ylim(0,12)+
  #Text for significant differences and p values between group. Replace values with comparison results.
  geom_text(x = 1.5, y = 11, label = "p = 0.034")+
...
p <- ggplot(di_df, aes(x=as.factor(Period), y=Di)) + 
  ...
  geom_jitter(data = Y1, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "red",position=position_jitter(0.2)) + 
  geom_jitter(data = Y2, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "cornflowerblue",position=position_jitter(0.2)) + 
  geom_segment(aes(x = 0.5, y = 2.34, xend = 1.5, yend = 2.34))+
  geom_segment(aes(x = 1.5, y = 2.86, xend = 2.5, yend = 2.86))+
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.background = element_rect(fill='white', colour = "black"),
        axis.text = element_text(colour = "black"),
...
head(ui_df)
#write.csv(ui_df, file = "Uniqueness_HON.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #-0.14
obsDifBC <- meanB - meanC #0.18
...
p <- ggplot(Ui_Sum, aes(x=POP_HON, y=Ui, fill = POP_HON)) + 
  ...
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), labels = c("Extirpated","New additions","Shared species"))+
  ylim(0,5)+
  geom_text(x = 1.5, y = 4.3, label = "p = 0.11")+
  geom_text(x = 2.5, y = 4.3, label = "p = 0.02")+
...
head(di_df)
#write.csv(di_df, file = "Distinctiveness_FLOR.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #-0.97
obsDifBC <- meanB - meanC #0.61
...
N_obs <- 291; # Total number of observations
...
p <- ggplot(Di_Sum, aes(x=POP_FLOR, y=Di, fill = POP_FLOR)) + 
  ...
  geom_text(x = 2.5, y = 11, label = "p = 0.004")+
...
p <- ggplot(di_df, aes(x=as.factor(Period), y=Di)) + 
  ...
  geom_jitter(data = Y1, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "red",position=position_jitter(0.2)) + 
  geom_jitter(data = Y2, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "cornflowerblue",position=position_jitter(0.2)) + 
  geom_segment(aes(x = 0.5, y = 2.92, xend = 1.5, yend = 2.92))+
  geom_segment(aes(x = 1.5, y = 3.66, xend = 2.5, yend = 3.66))+
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.background = element_rect(fill='white', colour = "black"),
        axis.text = element_text(colour = "black"),
...
head(ui_df)
#write.csv(ui_df, file = "Uniqueness_FLOR.csv", row.names = FALSE)
...
p <- ggplot(Ui_Sum, aes(x=POP_FLOR, y=Ui, fill = POP_FLOR)) + 
  ...
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), labels = c("Extirpated","New additions","Shared species"))+
  #ylim(0,3)+
  geom_text(x = 1.5, y = 4.3, label = "p = 0.02")+
...
head(di_df)
#write.csv(di_df, file = "Distinctiveness_SAGU.csv", row.names = FALSE)
...
obsDifAB <- meanA - meanB #0.18
obsDifBC <- meanB - meanC #0.25
...
N_obs <- 260; # Total number of observations
...
p <- ggplot(Di_Sum, aes(x=POP_SAGU, y=Di, fill = POP_SAGU)) + 
  ...
  #Text for significant differences and p values between group. Replace values with comparison results.
  #Text for significant differences and p values between group. Replace values with comparison results.
  geom_text(x = 1.5, y = 11, label = "p = 0.19")+
  geom_text(x = 2.5, y = 11, label = "p = 0.08")+
...
p <- ggplot(di_df, aes(x=as.factor(Period), y=Di)) + 
  ...
  geom_jitter(data = Y1, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "red",position=position_jitter(0.2)) + 
  geom_jitter(data = Y2, aes(x = as.factor(Period), y = Di), size = 3, alpha = 0.5, colour = "cornflowerblue",position=position_jitter(0.2)) + 
  geom_segment(aes(x = 0.5, y = 2.71, xend = 1.5, yend = 2.71))+
  geom_segment(aes(x = 1.5, y = 2.67, xend = 2.5, yend = 2.67))+
  theme(panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(),
        panel.background = element_rect(fill='white', colour = "black"),
        axis.text = element_text(colour = "black"),
...
head(ui_df)
#write.csv(ui_df, file = "Uniqueness_SAGU.csv", row.names = FALSE)
...
p <- ggplot(Ui_Sum, aes(x=POP_SAGU, y=Ui, fill = POP_SAGU)) + 
  ...
  scale_fill_manual(values=c("red", "cornflowerblue", "azure3"), labels = c("Extirpated","New additions","Shared species"))+
  ylim(0,5)+
  geom_text(x = 1.5, y = 4.3, label = "p = 0.17")+
